...
"[project]/.next-internal/server/app/api/get-report/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/get-report/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const filePath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), 'tmp', `${paymentId}.json`);
        try {
            const fileContent = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["readFile"])(filePath, 'utf-8');
            ...
            try {
                ...
                const tmpDir = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), 'tmp');
                const files = fs.readdirSync(tmpDir).filter((file)=>file.endsWith('.json') && file.startsWith('kirvano_'));
                if (files.length === 0) {
                ...
                const latestFilePath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(tmpDir, latestFile);
                const latestFileContent = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["readFile"])(latestFilePath, 'utf-8');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__639b98f3._.js.map